      ...
      <TermsContainer>
        ...
        <TermsWrapper>
          <section>
            ...
            <p>
              Welcome to Emowell. These terms and conditions outline the rules and regulations for the use of Emowell's website and services. By accessing this website, we assume you accept these terms and conditions. Do not continue to use Emowell if you do not agree to all of the terms and conditions stated on this page.
            </p>
          </section>
          <section>
            <h2>Eligibility</h2>
          ...
          <section>
            ...
            <p>
              Unless otherwise stated, Emowell and/or its licensors own the intellectual property rights for all material on Emowell. All intellectual property rights are reserved. You may access this from Emowell for your own personal use subjected to restrictions set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from Emowell</li>
              <li>Sell, rent, or sub-license material from Emowell</li>
              <li>Reproduce, duplicate, or copy material from Emowell</li>
              <li>Redistribute content from Emowell</li>
            </ul>
          </section>
          <section>
            <h2>User Accounts</h2>
          ...
          <section>
            <h2>Contact Us</h2>
            <p>
              If you have any questions about these terms,<br />please contact us at: Email: support@emowell.com
            </p>
          </section>
        </TermsWrapper>
      </TermsContainer>
