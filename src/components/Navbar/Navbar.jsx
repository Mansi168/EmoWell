    ...
    <>
      ...
      <Link to="/" onClick={handleLogoClick}>
        ...
        <NavLogo>
          ...
          <NavImg data-aos="fade-right">
            <img src={logo} alt="favicon" height="60" />
          ...
          <NavMenu isOpen={isOpen}>
            <Navitem data-aos="fade-down" data-aos-duration="1000">
              <NavLinks to="/" onClick={handleLogoClick}>
                Home
              </NavLinks>
            </Navitem>
            <Navitem data-aos="fade-down" data-aos-duration="1100">
              <NavLinks onClick={() => scrollToSection("about")}>
                About
              </NavLinks>
            </Navitem>
            <Navitem className="custom" data-aos="fade-down" data-aos-duration="1200">
              <NavLinks onClick={() => scrollToSection("featureSection")}>
                Features
              </NavLinks>
            </Navitem>
            <Navitem data-aos="fade-down" data-aos-duration="1300">
              <NavLinks to="/contact" onClick={handleLogoClick}>
                Contact
              </NavLinks>
            </Navitem>
            <Navitem data-aos="fade-down" data-aos-duration="1400">
            ...
            {isAuthenticated ? (
              <li>
                <Dropdown>
                  ...
                  {isOpen && (
                    <Dropdowncontent data-aos="fade-left" data-aos-duration="1000">
              ...
              <li>
                ...
                data-aos="fade-left" data-aos-duration="1000"
                  ...
                  style={{ border: "1px solid rgb(48,175,91)" }}
                >
                  Register
                </Button>
              </li>
