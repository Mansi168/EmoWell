        ...
        <div className="content">
            <div className="card" style={{width: "18rem"}}>
                ...
                <div className="card-body">
                    ...
                    <a href="https://pcl.psychiatry.uw.edu/wp-content/uploads/2021/12/YBOCS.pdf" target="_blank" className="btn btn-primary">Take the test</a>
                </div>
            </div>
            <div className="card " style={{width: "18rem"}}>
                ...
                <div className="card-body">
                    ...
                    <a href="https://wwiqtest.com/?gad_source=1&gclid=EAIaIQobChMI7sf3_uaNhgMVlFsPAh026AKoEAAYASAAEgK2b_D_BwE" target="_blank" className="btn btn-primary" >Take the test</a>
                </div>
            </div>
            <div className="card" style={{width: "18rem"}}>
                ...
                <div className="card-body">
                    ...
                    <a href="https://www.bemindfulonline.com/test-your-stress" target="_blank" className="btn btn-primary" >Take the test</a>
                </div>
            </div>
        </div>
        </>
